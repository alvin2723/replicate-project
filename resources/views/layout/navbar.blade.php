<nav class="navbar navbar-expand-lg fixed-top navbar-light d-flex justify-content-center">
    <div class="container">
      <a class="navbar-brand text-uppercase" href="https://replicate-latihid.herokuapp.com/" rel="tooltip" data-original-title=""
      title=""><img src="{{asset('image/logo.png')}}" alt="" width="125" height="35"></a>
